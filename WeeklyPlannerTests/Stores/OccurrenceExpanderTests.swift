...
final class OccurrenceExpanderTests: XCTestCase {
    ...
    func testDailyFillsTheWindow() {
        let starts = OccurrenceExpander.occurrenceStarts(seriesStart: date(2026, 6, 1),
    ...
    func testWeeklyIntervalTwoSkipsAlternateWeeks() {
        let starts = OccurrenceExpander.occurrenceStarts(seriesStart: date(2026, 6, 1), // Monday
    ...
    func testWeeklyAcrossYearBoundaryAndDSTKeepsWallClockTime() {
        ...
        let starts = OccurrenceExpander.occurrenceStarts(seriesStart: date(2026, 12, 28),
