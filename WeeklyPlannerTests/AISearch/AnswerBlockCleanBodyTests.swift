...
final class AnswerBlockCleanBodyTests: XCTestCase {
    ...
    func testStripsSoloAsterisks() {
        XCTAssertEqual(AnswerBlock.cleanBody("*Meet with Sara* at 3 PM."),
    ...
    func testStripsMarkdownHeaders() {
        XCTAssertEqual(AnswerBlock.cleanBody("## Friday\nNothing on your plate."),
                       "Friday\nNothing on your plate.")
    }

    func testPreservesPlainText() {
        XCTAssertEqual(AnswerBlock.cleanBody("Three meetings on Friday: standup, design, and review."),
