...
final class NotificationContentBuilderTests: XCTestCase {
    func testTitleTruncatedAt64Chars() {
        ...
        let content = NotificationContentBuilder.timeBased(title: long,
    ...
    func testTimeBasedBodyContainsMinutes() {
        let content = NotificationContentBuilder.timeBased(title: "Lunch",
                                                           startsAt: Date(timeIntervalSinceReferenceDate: 800_000_000),
                                                           location: "Café Bleu",
                                                           minutesBefore: 15)
    ...
    func testLocationBasedBodyMentionsArrival() {
        let content = NotificationContentBuilder.locationBased(title: "Lunch",
                                                               locationName: "Marina")
