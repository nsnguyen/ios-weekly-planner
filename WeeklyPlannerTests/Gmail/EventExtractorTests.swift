...
final class EventExtractorTests: XCTestCase {
    ...
    func testStubExtractorAlwaysReturnsFalse() async throws {
        ...
        let result = try await sut.extract(subject: "Your reservation at Café Bleu",
                                           snippet: "Friday 7pm",
                                           fromName: "Resy",
    ...
    func testFakeResyConfirmationExtractsTitleAndStart() async throws {
        ...
        fake.nextResult = ExtractedEvent(isEvent: true,
        ...
        let result = try await fake.extract(subject: "Reservation confirmed",
                                            snippet: "Friday 7pm",
                                            fromName: "Resy",
                                            fromEmail: "reservations@resy.com",
                                            body: "...")
    ...
    func testFakeAmbiguousEmailReturnsIsEventFalse() async throws {
        let fake = FakeEventExtractor()
        fake.nextResult = ExtractedEvent(isEvent: false, title: "", startISO: "", endISO: "",
                                         location: "", categoryHint: "", confidence: 0.2)

        let result = try await fake.extract(subject: "Update from the team",
    ...
    func testFakeMissingTimeReturnsEmptyStart() async throws {
        let fake = FakeEventExtractor()
        fake.nextResult = ExtractedEvent(isEvent: true, title: "Meeting", startISO: "", endISO: "",
...
final class FakeEventExtractor: EventExtractor {
    var nextResult: ExtractedEvent = .init(isEvent: false, title: "", startISO: "", endISO: "",
