...
final class MessageClassifierTests: XCTestCase {
    func testResyConfirmationSenderPasses() {
        let v = MessageClassifier.classify(subject: "Your reservation at Café Bleu is confirmed",
                                           fromName: "Resy",
    ...
    func testTicketmasterSubjectKeywordPasses() {
        let v = MessageClassifier.classify(subject: "Your tickets for the show",
    ...
    func testPromotionalNewsletterFails() {
        let v = MessageClassifier.classify(subject: "50% off this weekend!",
    ...
    func testGenericTransactionalEmailPassesWhenSubjectHasKeyword() {
        let v = MessageClassifier.classify(subject: "Appointment confirmation — Dr. Smith",
