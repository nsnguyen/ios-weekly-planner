...
/// binding shadow, page curl); Group B will add the cream paper surface,
/// ruled lines, hole punches, and friends inside the content slot.
///
...
///    `UnevenRoundedRectangle` so it nests cleanly inside the spine. Group B's
///    `PaperSurface` slots in here.
