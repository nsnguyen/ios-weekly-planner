...
enum AccessibilityIDs {
    /// Day page
    static func daypageEventRow(_ id: UUID) -> String {
        "daypage.event.row.\(id)"
    }

    static func daypageTodoRow(_ id: UUID) -> String {
        "daypage.todo.row.\(id)"
    }
    ...
    /// Side tabs
    static func sideTab(_ dayIdx: Int) -> String {
        "daypage.sidetab.\(dayIdx)"
    }

    /// Top bar — Day/Week toggle segments + week chevrons
    static func dayWeekSegment(_ view: String) -> String {
        "topbar.dayweek.\(view)"
    }
    ...
    /// Week page
    static func weekpageDayRow(_ dayIdx: Int) -> String {
        "weekpage.day.row.\(dayIdx)"
    }
    ...
    /// Settings
    static func settingsThemeCard(_ key: String) -> String {
        "settings.theme.card.\(key)"
    }

    static func settingsFontCard(_ key: String) -> String {
    ...
    static func eventTemplateChip(_ id: String) -> String {
    ...
    static func notesRow(_ id: UUID) -> String {
        "notes.row.\(id)"
    }
    ...
    static func annotationView(_ id: UUID) -> String {
        "daypage.annotation.\(id)"
    }

    /// Static (not per-id): only one annotation is ever in edit mode.
    static let annotationActiveEditor = "daypage.annotation.editor"
    static func annotationStyleColor(_ token: String) -> String {
        "annotation.style.color.\(token)"
    }
